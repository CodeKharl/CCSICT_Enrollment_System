  ...
  public void selectionProcess(boolean isCourseShowed){
    switch (String.valueOf(getYearChoice()) + String.valueOf(getSemesterChoice())) {
      ...
      case "12" -> {
        ...
        setPreRequisite(addSameStringValueInArrayList(4, "None"));
      }
      ...
      case "33" -> {
        ...
        setPreRequisite(Arrays.asList("4th Year" + stringWithTabs_newLines(2, 14, "Standing" + newLinesString(1)), "None", "None"));
      }
