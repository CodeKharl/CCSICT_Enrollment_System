  ...
  public void selectionProcess(boolean isCourseShowed){
    switch (String.valueOf(getYearChoice()) + String.valueOf(getSemesterChoice())) {
      ...
      case "31" -> {
        ...
        setPreRequisite(Arrays.asList("DSA 121" + stringWithTabs_newLines(1, 14, "213, 212") + newLinesString(1),
      ...
      case "32" -> {
        ...
        setPreRequisite(Arrays.asList("DSA 315", "3rd Year" + stringWithTabs_newLines(2, 14, "Standing") + newLinesString(1),
      ...
      case "41" -> {
        ...
        setPreRequisite(Arrays.asList("4rd Year" + stringWithTabs_newLines(2, 14, "Standing") + newLinesString(1),
        "4rd Year" + stringWithTabs_newLines(2, 14, "Standing") + newLinesString(1),
        "None", "None", "None", "None"));
      }
