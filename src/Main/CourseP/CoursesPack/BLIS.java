  ...
  public void selectionProcess(boolean isCourseShowed){
    switch(String.valueOf(getYearChoice()) + String.valueOf(getSemesterChoice())){
      ...
      case "32" -> {
        ...
        setPreRequisite(Arrays.asList("LIS 111, " + stringWithTabs_newLines(1, 14, "LIS 311\n"), "LIS 111," + stringWithTabs_newLines(2, 14, "LIS 211,") + stringWithTabs_newLines(2, 14, "LIS 221,")  + stringWithTabs_newLines(1, 14, "LIS 212,") + stringWithTabs_newLines(1, 14, "LIS 311"), "LIS 313", "LIS ICT 311", "LIS ICT 311", "3nd Year" + stringWithTabs_newLines(1, 14, "Standing"), "3nd Year" + stringWithTabs_newLines(1, 14, "Standing")));
      }
